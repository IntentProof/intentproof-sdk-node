...
export INTENTPROOF_SDK_ID="${INTENTPROOF_SDK_ID:-node}"
export INTENTPROOF_SDK_NAME="${INTENTPROOF_SDK_NAME:-intentproof-sdk-node}"
export INTENTPROOF_SDK_LANGUAGE="${INTENTPROOF_SDK_LANGUAGE:-typescript}"
export INTENTPROOF_SDK_VERSION="${INTENTPROOF_SDK_VERSION:-$(node -p "JSON.parse(require('node:fs').readFileSync('${sdk_root}/packages/sdk/package.json','utf8')).version")}"
